...
const Header = () => {
  ...
  return (
    <>
      <div style={{ backgroundColor: 'teal', padding: '8px', display: 'flex', alignItems: 'center' }} className='header'>
        <div style={{display:"flex",flexDirection:"row"}}>
        <Link className='logo-container' to="/">
          <Logo className="logo" style={{ width: '60px', height: '60px', marginRight: '2px' }} />
        </Link>
        <h2 style={{position:"relative", top:"10px",alignItems:"center"}}>SHOP-SHY</h2>
        </div>
